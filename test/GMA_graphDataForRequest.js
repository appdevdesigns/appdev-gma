...
describe('test GMA.graphDataForRequest()',function(){
...
// AD.log('... ... done();')
    ...
    it('calling .graphDataForRequest() with no parameters should result in a rejected deferred:',function(done){

        GMA.graphDataForRequest()
        .fail(function(err){
    ...
    it('calling .graphDataForRequest() with no .req  parameter should result in a rejected deferred:',function(done){
    ...
    it('calling .graphDataForRequest() with no .nodeId  parameter should result in a rejected deferred:',function(done){

        GMA.graphDataForRequest({ req:reqObj })
        .fail(function(err){
            assert.ok(true, ' --> should respond with an error. ');
            assert.include(err.message, 'INVALID_PARAMS', ' --> error.message included INVALID_PARAMS:');
            done();
    ...
    it('calling .graphDataForRequest() on success should return a proper object :',function(done){
        ...
        GMA.graphDataForRequest({ req:reqObj, nodeId:1 })
        .fail(function(err){
...
//     it('calling .graphDataForRequest() on success should return expected results :',function(done){
